# Generated by Django 5.1.6 on 2025-04-09 19:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Загрузите фотографию для статьи', null=True, upload_to='news_photos/', verbose_name='Фотография')),
                ('tags', models.JSONField(blank=True, default=list, help_text='Выберите теги статьи', verbose_name='Теги')),
